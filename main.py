...
arr = [[0,0,0],[0,0,0],[0,0,0]]                         #store the values of each grid element as 0,1,2
grid = grid(arr)                                        
...
while(i<9):
    ...
    if(arr[row][col] == 0):                             #checking if square is unmarked before marking
        if(i%2):                                        
            arr[row][col] = 1                           #marks square with player 1's symbol (x)
        else:
            arr[row][col] = 2                           #marks square with player 2's symbol (o)
